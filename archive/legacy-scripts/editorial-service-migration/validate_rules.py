...
def main():
    parser = argparse.ArgumentParser(description="Validate transformed rules JSON")
    parser.add_argument("--path", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "output", "chromadb_rules.json")))
