...
INPUT = os.getenv("RULES_PATH", os.path.abspath(os.path.join(os.path.dirname(__file__), "output", "ai_writing_flow_chromadb_rules.json")))
...
def main():
    ...
    success = id_check.get("ok") and len(ids) >= 300
