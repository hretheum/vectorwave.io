...
def test_tools():
    ...
    audience = "technical_founder"
    platform = "LinkedIn"
    result = calculate_topic_fit_score(topic, audience, platform)
    print(result)
    print()
    ...
    print("-" * 50)
    result = generate_key_message(topic, audience, platform)
    print(result)
    print()
    
    # Test 4: Analyze All Audiences
    print("4. Testing Analyze All Audiences:")
    print("-" * 50)
    try:
        result = analyze_all_audiences(topic, platform)
        print(result)
    ...
    print("-" * 50)
    result = calibrate_tone("technical_founder")
    print(result)
